...
export default function Translate() {
  ...
  const handleTranslate = async () => {
    ...
    try {
      // Updated endpoint to /kalenjintranslate as per API docs
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/kalenjintranslate`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ text: input }), // Matches request schema
        }
      );
      ...
      // Accessing the correct response field
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/contributions`,
        {
          ...
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            translator_auth_id: user.uid, // Use the actual user ID
            language: "Kalenjin",
            english_sentence: input,
            translated_sentence: corrected,
            source: "flagged",
          }),
        }
      );
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="p-2 bg-neutral-50 dark:bg-neutral-800 rounded text-neutral-700 dark:text-neutral-200">
                    {input}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Enter the correct Kalenjin translation..."
                  />
                </div>
              </div>
                ...
                {loading ? (
                  <>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 flex rounded-md text-white ${
                        !corrected.trim()
