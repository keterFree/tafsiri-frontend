...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-green-100 dark:from-neutral-900 dark:to-neutral-800 pb-20 text-neutral-800 dark:text-neutral-100">
      <Navbar />
